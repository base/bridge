...
import {
  argsSchema,
  handleFinalizeSignatures,
} from "./finalize-signatures.handler";
...
export const finalizeSignaturesCommand = new Command("finalize-signatures")
  .description(
    "Finalize the signature list as complete and ready for verification"
  )
  .option(
  ...
  .action(async (options) => {
    ...
    await handleFinalizeSignatures(parsed.data);
  });
