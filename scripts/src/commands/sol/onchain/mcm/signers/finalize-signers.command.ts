...
import { argsSchema, handleFinalizeSigners } from "./finalize-signers.handler";
...
export const finalizeSignersCommand = new Command("finalize-signers")
  .description("Finalize the signer configuration for multisig")
  .option(
  ...
  .action(async (options) => {
    ...
    await handleFinalizeSigners(parsed.data);
  });
